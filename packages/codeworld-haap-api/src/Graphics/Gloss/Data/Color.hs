...
module Graphics.Gloss.Data.Color where

import qualified CodeWorld as CW

newtype Color = RGBA { rgbaOfColor :: (Float,Float,Float,Float) }
    deriving (Eq,Show)
    
-- | Make a custom color. All components are clamped to the range [0..1].
makeColor :: Float -> Float -> Float -> Float -> Color
makeColor r g b a = RGBA (r,g,b,a)

makeRawColor = makeColor

-- | Make a custom color. All components are clamped to the range [0..255].
makeColorI :: Int -> Int -> Int -> Int -> Color
makeColorI r g b a = makeRawColor (realToFrac r / 255) (realToFrac g / 255) (realToFrac b / 255) (realToFrac a / 255)
    
colorToCW :: Color -> CW.Color
colorToCW (RGBA (r,g,b,a)) = CW.RGBA (realToFrac r) (realToFrac g) (realToFrac b) (realToFrac a)
